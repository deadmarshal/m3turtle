...
<*EXTERNAL turtle_strafe_left*> PROCEDURE StrafeLeft(Pixels:int);
<*EXTERNAL turtle_strafe_right*> PROCEDURE StrafeRight(Pixels:int);
...
<*EXTERNAL turtle_fill_circle_here*> PROCEDURE FillCircleHere(Radius:int);
